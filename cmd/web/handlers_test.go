...
func TestShowSnippet(t *testing.T) {
	...
	tests := []struct {
		...
		{"Valid ID", "/snippet/1", http.StatusOK, []byte("Ana are mock und lorem ipsum dolor siat amet ...")},
...
func TestSignupUser(t *testing.T) {
	...
	tests := []struct {
		...
		{"Short password", "Bob", "bob@example.com", "$$", csrfToken, http.StatusOK, []byte("This field is too short (min 3 characters)")},
		{"Duplicate email", "Bob", "dupe@test.com", "validPa$$word", csrfToken, http.StatusOK, []byte("Address is already in use")},
